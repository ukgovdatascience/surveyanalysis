# impactedsurveyanalysis documentation build configuration file
#
...
project = "impactedsurveyanalysis"
author = "Data Labs"
...
htmlhelp_basename = "surveyanalysisdoc"
...
latex_documents = [
    ("index",
     "surveyanalysis.tex",
     u"impactedsurveyanalysis Documentation",
     u"Data Labs", "manual"),
]
...
man_pages = [
    ("index", "surveyanalysis", u"impactedsurveyanalysis Documentation",
     [u"Data Labs"], 1)
]
...
texinfo_documents = [
    ("index", "surveyanalysis", u"impactedsurveyanalysis Documentation",
     u"Data Labs", "impactedsurveyanalysis",
     "Analysis of ImpactEd's longitudinal survey.", "Miscellaneous"),
]
